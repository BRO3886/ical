...
ical is a native macOS CLI that manages Calendar events through [go-eventkit](https://github.com/BRO3886/go-eventkit), a Go library providing direct EventKit bindings via cgo. This gives ical near-native performance — roughly 3000x faster than AppleScript-based alternatives.
